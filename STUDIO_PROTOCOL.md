...
- does not implement repo ingestion, repo upload handling, OAuth, vector storage, database schemas, dashboard UI, code asset ingestion, or asset installation automation unless explicitly requested
